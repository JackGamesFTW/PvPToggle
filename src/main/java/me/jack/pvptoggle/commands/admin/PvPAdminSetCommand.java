...
public class PvPAdminSetCommand extends AbstractCommand {
    ...
    private static final Message MSG_INVALID_KEY = Message.raw("Invalid key. Valid keys: combattimer, cooldown, default, persist");
    ...
    public PvPAdminSetCommand() {
        ...
        this.keyArg = this.withRequiredArg("key", "Config key (combattimer, cooldown, default, persist)", ArgTypes.STRING);
